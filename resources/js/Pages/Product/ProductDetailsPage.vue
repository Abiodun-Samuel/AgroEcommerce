<template>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="product__details my-1 bg-white shadow-sm p-1">
                        ...
                        <div
                            data-aos="zoom-in"
                            v-if="productTab == 'product-details'"
                        >
                        ...
                        <div
                            data-aos="zoom-in"
                            v-if="productTab == 'product-reviews'"
                        >
                            <p class="text-dark fw-bolder">
                                Verified ratings and comments ({{
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-4 col-sm-4 my-1">
                                    <div
                                        class="review__total rounded shadow-sm p-1"
                                    >
                                ...
                                <div
                                    class="col-lg-9 col-md-8 col-sm-8 my-1 review__box"
                                >
                                    <template v-if="sortReviews.length">
                                        <div class="">
                                            <div
                                                v-for="review in sortReviews"
                                                :key="review.id"
                                            >
                                                <p class="lead">
                                                    <Rating
                                                ...
                                                >
                                                    <p
                                                        class="text-secondary fw-light mb-0 pb-0"
                                                    >
                                                        <span
                                                            >{{
                                                                formatTime(
                                                    ...
                                                    <p
                                                        class="d-flex align-items-center text-success fw-normal mb-0 pb-0"
                                                    >
                                                        <Icon
                                                            height="15"
                                                            width="15"
                                    ...
                                    <template v-else>
                                        <div class="bg-white text-center">
                                            <h4 class="text-danger fw-bolder">
                                                No product reviews
                                            </h4>
                                        </div>
                                    </template>
    ...
    >
        <template #header>
            <h4
                class="modal-title text-primary d-flex align-items-center gap-1 fw-bolder"
            >
...
const addToCart = () => {
    ...
    if (productForm.quantity == 0)
        return toast.error("Please increase your product quantity");
