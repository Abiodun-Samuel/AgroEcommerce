<template>
            ...
            <div class="dropdown box">
              ...
              >
                ...
                <span class="d-none d-lg-flex">
                  {{ auth_user ? auth_user.first_name : "Account" }}</span
                >
                <Icon
                  height="20"
                  width="20"
  ...
  <div class="mobile__nav shadow-lg bg-light">
    <div class="container">
      <div class="mobile__top d-flex justify-content-between align-items-start">
        <Link :href="route('home')" class="d-flex align-items-center">
          <img src="../../../images/logo/logo.png" alt="logo" width="100" />
        </Link>
        ...
        <div @click="mobileNavHandler">
          <button class="border-0 btn p-0 m-0">
            <Icon class="text-danger" height="30" icon="carbon:close-filled" />
          </button>
        </div>
      </div>
      <hr />
      ...
      <div class="mobile_nav_links">
        <nav class="d-flex justify-content-start gap-1 flex-column">
          ...
          <Link :href="route('product-page')" class="d-flex align-items-center">
            <Icon icon="ri:shopping-basket-2-line" />
            <span style="margin-left: 5px">Products</span>
          </Link>
          <Link :href="route('home')" class="d-flex align-items-center">
      ...
      <div class="d-flex justify-content-between align-items-center">
        <div class="contact-icons my-1">
          <a target="_blank" href="https://wa.me/message/KK2QPDR6KTLBK1">
            <i>
          ...
          <a target="_blank" href="https://www.instagram.com/superoagrobase/">
            <i>
...
onMounted(() => {
  ...
  window.addEventListener("scroll", function (t) {
    ...
    o < e && e > 80
      ...
      : o > e && (n.classList.remove("slideUp"), n.classList.add("slideDown")),
      (o = e);
  });
});
</script>
