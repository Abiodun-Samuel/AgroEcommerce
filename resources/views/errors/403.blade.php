...
<body>
    <div class="container d-flex justify-content-center align-items-center">
        <div class="shadow w-50 h-50 mt-3">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
                <g id="freepik--background-simple--inject-25">
                    <path
                        ...
                        style="fill:#28C76F"></path>
                    <path
                        d="M55.48,273.73s2.32,72,62.43,120,143.41,51.43,210.84,56,119.23-33.62,127-91.32-43.72-74.64-71.68-140.33S358.64,130.8,299.49,90.4,147.8,74.81,99.29,144,55.48,273.73,55.48,273.73Z"
                        style="fill:#fff;opacity:0.7000000000000001"></path>
                </g>
                <g id="freepik--Padlock--inject-25">
                    <path
                ...
                <g id="freepik--Character--inject-25">
                    ...
                    <path
                        ...
                        style="fill:#28C76F;stroke:#263238;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.166343341900884px">
                    </path>
                    <path
                ...
                <g id="freepik--security-barrier--inject-25">
                    ...
                    <rect x="55.73" y="293.21" width="271.93" height="26.36"
                        style="fill:#28C76F;stroke:#263238;stroke-miterlimit:10;stroke-width:1.166343341900884px">
                    </rect>
